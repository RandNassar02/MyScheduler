                    ...
                    using (var reader = ExcelReaderFactory.CreateReader(stream))
                    {
                        ...
                        do
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                planContent.StudyPlan = await _context.studyPlan.FindAsync(StudyPlanId);
                    ...
                    using (var reader = ExcelReaderFactory.CreateReader(stream))
                    {
                        ...
                        do
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                student.studyPlan = await _context.studyPlan.FindAsync(studyPlanId);
                    ...
                    using (var reader = ExcelReaderFactory.CreateReader(stream))
                    {
                        ...
                        do
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                section.Instructors = await _context.instractors.FindAsync(instructorId);
